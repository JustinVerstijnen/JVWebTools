(() => {
  ...
  function exportToHtml(out) {
    ...
    bodyHtml += `<p class="footer-text">This report was generated by <a href="https://365recordsgenerator.justinverstijnen.nl">Microsoft 365 DNS Record Generator</a> by Justin Verstijnen.</p>
    </div>`;
